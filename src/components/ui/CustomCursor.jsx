    ...
    <>
      ...
      {theme === 'cozy' && (
        ...
        >
          ...
          <div 
            className="absolute bottom-[12px] left-0 min-w-[120px] max-w-[220px] bg-[#F5F0E8] text-[#3A2E2A] text-[12px] font-bold p-2 px-3 rounded-xl border-[1.5px] border-[#D8CEBC] shadow-[0_4px_12px_rgba(58,46,42,0.1)] mb-2 text-center transition-all duration-300 ease-out origin-bottom" 
            style={{ 
          ...
          <div 
            ...
            className="absolute"
            style={{ 
              left: '-8px', // Shifted to visually center the 56px image
              top: '-4px',
          ...
          >
            <img 
              ...
              className="w-[56px] max-w-none drop-shadow-[0_4px_6px_rgba(58,46,42,0.25)]"
              draggable="false"
            />
          </div>
        </div>
